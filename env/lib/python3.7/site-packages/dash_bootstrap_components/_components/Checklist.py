...
- inline (boolean; optional): Arrange Checklist inline"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, options=Component.UNDEFINED, values=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, key=Component.UNDEFINED, inputStyle=Component.UNDEFINED, inputClassName=Component.UNDEFINED, labelStyle=Component.UNDEFINED, labelClassName=Component.UNDEFINED, inline=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'options', 'values', 'className', 'style', 'key', 'inputStyle', 'inputClassName', 'labelStyle', 'labelClassName', 'inline']
        self._type = 'Checklist'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'options', 'values', 'className', 'style', 'key', 'inputStyle', 'inputClassName', 'labelStyle', 'labelClassName', 'inline']
