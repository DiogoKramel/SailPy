...
def optimization_platypus_vpp():
    ...
    def function_platypus_vpp(vars):
        ...
        bwl = np.float(vars[0])
        #sailset, loa, lwl, bwl, tc, disp, lcb, lcf, cb, cm, cp, cwp, alcb, boa, scb, kg, GMtrans, fb, lr, xcea, mcrew
        resultados = vpp_solve('main+genoa', 12.041, 10.012, 3.71, bwl, 0.567, -0.346, -0.6, 0.43, 0.77, 0.558, 0.715, 4.5, 25.2, 0.8, 1.3, 5.674, 0.7, \
