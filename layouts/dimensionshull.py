...
hull = dbc.Container([
    dbc.Row([
        ...
        dbc.Col([
            ...
            html.Div(style={'width': '100vh'}, children=dcc.Graph(id='insert-sac', style={'width': 'inherit'})),
            html.Br(),
            html.Div(style={'width': '100vh'}, children=dcc.Graph(id='insert-wl', style={'width': 'inherit'})),
            html.Br(),
            html.Div(style={'width': '100vh'}, children=dcc.Graph(id='insert-keel', style={'width': 'inherit'})),
            html.Br(),
            html.Div(style={'width': '100vh'}, children=dcc.Graph(id='insert-section', style={'width': 'inherit'})),
            html.Br(),
