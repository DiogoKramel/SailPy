...
def create_keel(lwl, tc, angle_keel_bow, angle_keel_stern):
    keel_solution = keel_solve(np.float(lwl), np.float(tc), np.radians(np.float(angle_keel_bow)), np.radians(np.float(angle_keel_stern)))
    return {
        'data': [
            go.Scatter(
                x = keel_solution[0],
...
def create_section(lwl, beta_n, beta_n2, cb, lcb, alpha_f_sac, alpha_i_sac, beamtransom, bwl, tc, cm, lcf, cwp, angle_keel_bow, angle_keel_stern):
    ...
    return {
        'data': [
            go.Scatter(
                x = -section_solution[1][0],
                y = section_solution[2][0],
                name = "Section 10",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = -section_solution[1][1],
                y = section_solution[2][1],
                name = "Section 9",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = -section_solution[1][2],
                y = section_solution[2][2],
                name = "Section 8",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = -section_solution[1][3],
                y = section_solution[2][3],
                name = "Section 7",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = -section_solution[1][4],
                y = section_solution[2][4],
                name = "Section 6",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = section_solution[1][5],
                y = section_solution[2][5],
                name = "Section 5",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = section_solution[1][6],
                y = section_solution[2][6],
                name = "Section 4",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = section_solution[1][7],
                y = section_solution[2][7],
                name = "Section 3",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = section_solution[1][8],
                y = section_solution[2][8],
                name = "Section 2",
                mode = 'lines',
                cliponaxis = False,
            ),
            go.Scatter(
                x = section_solution[1][9],
                y = section_solution[2][9],
                name = "Section 1",
                mode = 'lines',
                cliponaxis = False,
            ),
